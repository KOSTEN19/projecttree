...
```
cd existing_repo
git remote add origin https://gitlab.com/WellHoHo/projecttree.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/WellHoHo/projecttree/-/settings/integrations)
